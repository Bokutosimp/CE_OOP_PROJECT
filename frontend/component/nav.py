    ...
    try:
        if 'auth' in session and session['auth']:
            if session['auth'][1] == 'Admin':
                ...
                login_nav = Div(
                    Div(A('logout', href='/logout'), 
                        A('product management', href=f'/seller',cls='verticle_nav') if session['auth'][1] == 'Seller' else None,
                        A('History', href=f'/history',cls='verticle_nav') ,
                        A('profile ',Svg(Path(d='M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0'),
                            Path(fill_rule='evenodd',d='M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1'),xmlns="http://www.w3.org/2000/svg" ,width="16" ,height="16", fill="currentColor", cls="bi bi-person-circle", viewBox="0 0 16 16",
                            ),href='/profile',cls='verticle_nav'),
                        style="display:flex; gap:10px;"),
                    A(Svg(Path(d='M0 2.5A.5.5 0 0 1 .5 2H2a.5.5 0 0 1 .485.379L2.89 4H14.5a.5.5 0 0 1 .485.621l-1.5 6A.5.5 0 0 1 13 11H4a.5.5 0 0 1-.485-.379L1.61 3H.5a.5.5 0 0 1-.5-.5M3.14 5l1.25 5h8.22l1.25-5zM5 13a1 1 0 1 0 0 2 1 1 0 0 0 0-2m-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0m9-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2m-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0'),
                    viewBox='0 0 16 16', h='16', w='16', xmlns='http://www.w3.org/2000/sv', fill='currentColor'),
                    href='/cart'
