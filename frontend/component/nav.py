...
def nav(session):
    login_nav = Div(
        ...
        A(Svg(Path(d='M0 2.5A.5.5 0 0 1 .5 2H2a.5.5 0 0 1 .485.379L2.89 4H14.5a.5.5 0 0 1 .485.621l-1.5 6A.5.5 0 0 1 13 11H4a.5.5 0 0 1-.485-.379L1.61 3H.5a.5.5 0 0 1-.5-.5M3.14 5l1.25 5h8.22l1.25-5zM5 13a1 1 0 1 0 0 2 1 1 0 0 0 0-2m-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0m9-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2m-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0'),viewBox='0 0 16 16',h='16',w='16',xmlns='http://www.w3.org/2000/sv',fill='currentColor'),href='/cart'),
        style='height:25px; display:flex; justify-content:space-between; padding:0 40px;'
      ),
    guess_nav = Div(
        Div(
        A('Sign in',href='/login' ,style='text-decoration:underline;'),Span(' or '),
        A('register',href='register',style='text-decoration:underline;')),
        A(Svg(Path(d='M0 2.5A.5.5 0 0 1 .5 2H2a.5.5 0 0 1 .485.379L2.89 4H14.5a.5.5 0 0 1 .485.621l-1.5 6A.5.5 0 0 1 13 11H4a.5.5 0 0 1-.485-.379L1.61 3H.5a.5.5 0 0 1-.5-.5M3.14 5l1.25 5h8.22l1.25-5zM5 13a1 1 0 1 0 0 2 1 1 0 0 0 0-2m-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0m9-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2m-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0'),viewBox='0 0 16 16',h='16',w='16',xmlns='http://www.w3.org/2000/sv',fill='currentColor'),href='/login'),
        style='height:30px; display:flex; justify-content:space-between; padding:0 40px;'
      ),
    try:
      if session['auth']:
