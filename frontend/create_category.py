...
def post_create_category(category_name:str,category_description:str,session):
   try:
      ...
      main_system.create_category(uuid.uuid4(),category_name,category_description,session['auth'][0])
      return Div(
      ...
      return Script(f"alert('{str(e)}'); window.location.href='/admin/create_category';")